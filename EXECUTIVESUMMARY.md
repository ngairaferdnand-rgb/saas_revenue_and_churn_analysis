...
1️⃣**The Churn Crisis:**
- **Overall Churn Rate: 52.17%.** More than half of all customers acquired (313 out of 600) have departed. This indicates that **for every new customer gained, approximately one is lost.**
- **High-Risk Segments:** The Starter Plan shows the highest churn at 70.51%, suggesting a disconnect between marketing promises and product reality.
<br>

2️⃣ **The October, June & September Leaks:** 
- The use of waterfall analysis identified specific periods of catastrophic revenue contraction:
  - **June (-$33k) and September (-$37k):** These months **represent net negative retention.** In September specifically, a surge in new business was nearly neutralised by existing customer losses.
  - **The Rescue Mission Dynamic:** High growth peaks are currently serving as "rescue missions" to prevent total MRR collapse rather than reflecting sustainable market expansion.
<br>

3️⃣ **Engagement and Support Correlation:**
- **The "Zombie" Profile:** Churned customers averaged only 25.1% feature usage compared to 55% for active users.
- **Support Overload:** Customers lost in September cited "Poor Support" and "Missing Features" as primary reasons, averaging 8.8 support tickets annually. This suggests that acquisition surges are overwhelming the support infrastructure, leading to a quality crash.
<br>
...
- **Pivot to Expansion MRR:** We need to shift KPIs from purely "New Business" to "Net Revenue Retention." Increasing existing customer spend by just 5% would stabilize the MRR more effectively than new acquisition.
